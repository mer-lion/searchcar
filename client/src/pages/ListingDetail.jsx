          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="flex gap-2 mt-4">
              <a href={listing.url} target="_blank" rel="noopener noreferrer"
                className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700">Orijinal İlanı Gör</a>
              ...
              <button onClick={handleSuspiciousCheck} disabled={suspLoading}
                ...
                {suspLoading ? "Kontrol Ediliyor..." : "Dolandiricilik Kontrolu"}
              </button>
            </div>
          </div>
