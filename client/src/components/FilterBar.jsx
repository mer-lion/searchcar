    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-wrap gap-3 items-end">
      ...
      <div>
        ...
        <input type="text" value={filters.model} onChange={(e) => handleChange("model", e.target.value)}
          placeholder="Golf, Corolla..." className="border border-gray-300 rounded-lg px-3 py-1.5 text-sm w-32" />
      </div>
      <div>
        ...
        <input type="number" value={filters.priceMin} onChange={(e) => handleChange("priceMin", e.target.value)}
          placeholder="500000" className="border border-gray-300 rounded-lg px-3 py-1.5 text-sm w-28" />
      </div>
      <div>
        ...
        <input type="number" value={filters.priceMax} onChange={(e) => handleChange("priceMax", e.target.value)}
          placeholder="2000000" className="border border-gray-300 rounded-lg px-3 py-1.5 text-sm w-28" />
      </div>
      <div>
        ...
        <input type="number" value={filters.mileageMax} onChange={(e) => handleChange("mileageMax", e.target.value)}
          placeholder="150000" className="border border-gray-300 rounded-lg px-3 py-1.5 text-sm w-28" />
      </div>
      <div>
